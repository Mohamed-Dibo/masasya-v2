...
const responses = {
    ...
    products: [
      ...
      'غرف مطبخ', 'دواليب مطبخ', 'مطابخ جاهزة', 'مطابخ تفصيل', 'منتجات المطبخ','منتج','منتجات','المنتجات','الاصناف','صنف','الأصناف'
    ],
    pricing: [
     'الأسعار', 'كم السعر', 'كم يكلف', 'بكم', 'السعر', 'التكلفة', 'عرض سعر', 'كم قيمة', 'سعر المتر', 'الاسعار', 'غالية', 'رخيصة'
    ],
    contact: [
  ...
  const botResponses = {
    ...
    complaint: ' 📞 تواصل معنا عبر:\n0508575471 – 0126595572\n📧 البريد:\nmas.asya1975@gmail.com\nasya-trading@hotmail.com\n نعتذر عن أي إزعاج،اتواصل بنا من خلال ارقام الهواتف وهنخدمك في اي وقت، وسنقوم بخدمتك فوراً. رضاك يهمنا!',
    time: '⏰ أوقات الدوام:\nالأحد إلى الخميس: 9 صباحاً – 5 مساءً\nالجمعة والسبت: إجازة',
    delivery: '🚚نعم، نوفر التوصيل والتركيب حسب الموقع  جدة ومكه خلاص 24 ساعه وباقي المدن من خلال شركات الشحن.',
